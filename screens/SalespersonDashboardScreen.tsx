            ...
            {features.includes('estoque_inteligente') && currentSubView === 'dashboard' ? (
              <>
                <FilterBar
                    ...
                    // FIX: Explicitly typing `val` as `string[]` helps TypeScript infer the correct type for `val.length`.
                    activeAdvancedFiltersCount={Object.values(filters).reduce((acc, val: string[]) => acc + val.length, 0)}
